...
function usage() {
  console.log(`
Usage:
  node figma_extract/bin/extract-page-desktop.mjs <pageName> <rootNodeId>

Example:
  node figma_extract/bin/extract-page-desktop.mjs home 13:1321
`);
  process.exit(1);
}
